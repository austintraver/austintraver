...
- 🐍 Python is a very powerful language too, I use it quite often. Aside from Python, I coded my [color theme for the IntelliJ-based IDEs][Professor Theme] in Java, and I wrote a [browser extension for Chrome and Firefox][Web Extension] in JavaScript. Each language has certain types of problems that it is particularly well-suited solve, though I try to stay flexible
